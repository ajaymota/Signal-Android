...
import org.privately.chat.gcm.FcmUtil;
import org.privately.chat.logging.Log;
import org.privately.chat.push.AccountManagerFactory;
import org.privately.chat.registration.PushChallengeRequest;
    ...
    new AsyncTask<Void, Void, VerificationRequestResult>() {
      ...
      VerificationRequestResult doInBackground(Void... voids) {
        try {
          ...
          org.privately.chat.logging.Log.w(TAG, "Error during account registration", e);
