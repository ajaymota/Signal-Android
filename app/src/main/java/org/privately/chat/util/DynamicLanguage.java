...
import org.privately.chat.util.dynamiclanguage.LanguageString;

import java.util.Locale;

/**
 * @deprecated Use a base activity that uses the {@link org.privately.chat.util.dynamiclanguage.DynamicLanguageContextWrapper}
 */
@Deprecated
