...
import org.privately.chat.database.GroupDatabase.GroupRecord;
...
public class PushGroupUpdateJob extends BaseJob {
  ...
  public static final class Factory implements Job.Factory<PushGroupUpdateJob> {
    @Override
    public @NonNull PushGroupUpdateJob create(@NonNull Parameters parameters, @NonNull org.privately.chat.jobmanager.Data data) {
