...
public class MmsBodyProvider extends ContentProvider {
  ...
  private static final String CONTENT_URI_STRING = "content://org.privately.provider.chat.mms/mms";
  ...
  static {
    ...
    uriMatcher.addURI("org.privately.provider.chat.mms", "mms/#", SINGLE_ROW);
  }
