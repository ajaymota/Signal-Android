...
import org.privately.chat.util.MemoryFileUtil;
...
public class PartProvider extends ContentProvider {
  ...
  private static final String CONTENT_URI_STRING = "content://org.privately.provider.chat/part";
  ...
  static {
    ...
    uriMatcher.addURI("org.privately.provider.chat", "part/*/#", SINGLE_ROW);
  }
