...
import org.privately.chat.BindableConversationListItem;
import org.privately.chat.R;
import org.privately.chat.Unbindable;
import org.privately.chat.components.AlertView;
import org.privately.chat.components.AvatarImageView;
import org.privately.chat.components.DeliveryStatusView;
import org.privately.chat.components.FromTextView;
import org.privately.chat.components.ThumbnailView;
import org.privately.chat.components.TypingIndicatorView;
import org.privately.chat.database.MmsSmsColumns;
...
import org.privately.chat.util.ExpirationUtil;
    ...
    BindableConversationListItem, Unbindable
{
  ...
  private static SpannableString getThreadDisplayBody(@NonNull Context context, @NonNull ThreadRecord thread) {
    if (thread.getGroupAddedBy() != null) {
      ...
      return emphasisAdded(context.getString(org.privately.chat.R.string.ThreadRecord_called));
    } else if (SmsDatabase.Types.isIncomingCall(thread.getType())) {
      return emphasisAdded(context.getString(org.privately.chat.R.string.ThreadRecord_called_you));
    } else if (SmsDatabase.Types.isMissedCall(thread.getType())) {
      return emphasisAdded(context.getString(org.privately.chat.R.string.ThreadRecord_missed_call));
