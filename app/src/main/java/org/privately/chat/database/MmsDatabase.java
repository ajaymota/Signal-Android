...
import org.privately.chat.attachments.MmsNotificationAttachment;
import org.privately.chat.contactshare.Contact;
import org.privately.chat.database.documents.IdentityKeyMismatch;
import org.privately.chat.database.documents.IdentityKeyMismatchList;
import org.privately.chat.database.documents.NetworkFailure;
import org.privately.chat.database.documents.NetworkFailureList;
import org.privately.chat.database.helpers.SQLCipherOpenHelper;
import org.privately.chat.database.model.MediaMmsMessageRecord;
import org.privately.chat.database.model.MessageRecord;
import org.privately.chat.database.model.NotificationMmsMessageRecord;
...
import org.privately.chat.mms.MessageGroupContext;
import org.privately.chat.mms.MmsException;
import org.privately.chat.mms.OutgoingExpirationUpdateMessage;
import org.privately.chat.mms.OutgoingGroupUpdateMessage;
...
import org.privately.chat.revealable.ViewOnceExpirationInfo;
...
import static org.privately.chat.contactshare.Contact.Avatar;
...
//  }
  ...
  public void markIncomingNotificationReceived(long threadId) {
    ...
    if (org.privately.chat.util.Util.isDefaultSmsProvider(context)) {
      DatabaseFactory.getThreadDatabase(context).incrementUnread(threadId, 1);
    }
  ...
  public class Reader implements Closeable {
    ...
    private NotificationMmsMessageRecord getNotificationMmsMessageRecord(Cursor cursor) {
      ...
      if (!TextUtils.isEmpty(contentLocation))
        contentLocationBytes = org.privately.chat.util.Util.toIsoBytes(contentLocation);

      if (!TextUtils.isEmpty(transactionId))
        transactionIdBytes = org.privately.chat.util.Util.toIsoBytes(transactionId);
